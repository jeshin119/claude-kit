...
- 독자가 앞 대화나 원문을 되짚지 않아도 되게 쓸 것. 아래 셋이 그 방법이다.
  ...
  - 이 대화에서 만든 이름은 첫 등장에 한 줄로 정의할 것.
...
- 제목에는 그 절의 내용을 넣을 것. Why now 같은 영어 제목을 그대로 옮기지 않는다.
  - 왜 지금인가 → 지금 해야 하는 이유
