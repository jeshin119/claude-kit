...
| `project-doc-framework` | `doc-protocols` | 프로젝트 문서를 세우고·갱신하고·정리한다. 19개 항목을 갱신 주기가 다른 6개 층으로 나누고, 규모 프로파일(M/L)로 만들 파일을 정하고, 추적 사슬로 목적과 검증을 잇는다 | 코드 주석·커밋 메시지, 산문 윤문 |
